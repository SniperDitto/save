 ...
 * Generated at: 2022-05-09 05:28:34 UTC
...
public final class ajaxTest2_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("		httpRequest.onreadystatechange = setHMenus;\r\n");
      out.write("		//get or post, 데이터 파일 경로, 동기인지(비동기인지)\r\n");
      out.write("		httpRequest.open(\"post\",\"./ajaxPages/getHmenus.jsp\",true);\r\n");
      ...
      out.write("		\r\n");
      out.write("		//통신이 완료되면 실행할 메서드\r\n");
      out.write("		httpRequest.onreadystatechange = setLMenus;\r\n");
      out.write("		//get or post, 데이터 파일 경로, 동기인지(비동기인지)\r\n");
      out.write("		httpRequest.open(\"post\",\"./ajaxPages/getLmenus.jsp\",true);\r\n");
      out.write("		httpRequest.send();\r\n");
      out.write("	}\r\n");
      out.write("	\r\n");
      ...
      out.write("			var objXML = httpRequest.responseXML;\r\n");
      ...
      out.write("				hMenuName = arrHMenu[i].childNodes[0].childNodes[0].nodeValue;\r\n");
      out.write("				\r\n");
      ...
      out.write("					strHTML += \"</option>\";\r\n");
      out.write("				}\r\n");
      out.write("			}else if(obj.value.equals(\"MENU03\")){\r\n");
      out.write("				for(var i=5;i<8;i++){\r\n");
      out.write("					lMenuID = arrLMenu[i].childNodes[0].childNodes[0].nodeValue;\r\n");
      out.write("					lMenuName = arrLMenu[i].childNodes[0].childNodes[0].nodeValue;\r\n");
      out.write("					\r\n");
      out.write("					strHTML += \"<option value='\"+lMenuID+\"'>\";\r\n");
      ...
      out.write("					strHTML += \"</option>\";\r\n");
      out.write("				}\r\n");
      out.write("			}else if(obj.value.equals(\"MENU04\")){\r\n");
      out.write("				for(var i=8;i<12;i++){\r\n");
      out.write("					lMenuID = arrLMenu[i].childNodes[0].childNodes[0].nodeValue;\r\n");
      out.write("					lMenuName = arrLMenu[i].childNodes[0].childNodes[0].nodeValue;\r\n");
      out.write("					\r\n");
      out.write("					strHTML += \"<option value='\"+lMenuID+\"'>\";\r\n");
      ...
      out.write("					strHTML += \"</option>\";\r\n");
      out.write("				}\r\n");
      out.write("			}else if(obj.value.equals(\"MENU05\")){\r\n");
      out.write("				for(var i=12;i<13;i++){\r\n");
      out.write("					lMenuID = arrLMenu[i].childNodes[0].childNodes[0].nodeValue;\r\n");
      out.write("					lMenuName = arrLMenu[i].childNodes[0].childNodes[0].nodeValue;\r\n");
      out.write("					\r\n");
      out.write("					strHTML += \"<option value='\"+lMenuID+\"'>\";\r\n");
      ...
      out.write("		<select id=\"hMenu\" onchange=\"setLMenu(this)\">\r\n");
      out.write("		</select>\r\n");
