...
--UPDATE
  PROCEDURE PROC_UP_ADMISSION_ROOMS
    (
        ...
        --있으면 1 없으면 0
        V_CHK_ADM_ID    CHAR(1);--병실테이블에서 확인
        V_CHK_A_ROOM_DATE   NUMBER;
        V_CHK_GRP_ID    CHAR(1);
        V_CHK_COM_ID    CHAR(1);
  ...
  BEGIN
    ...
    ELSE
        ...
        ELSE
            ...
            SET
                ADM_ROOM_GRP=IN_ADM_ROOM_GRP
                ,ADM_ROOM=IN_ADM_ROOM
...
--DELETE
  ...
  BEGIN
    ...
    ELSE
        ...
        WHERE ADM_ID=IN_ADM_ID
            AND ADM_ROOM_DATE=IN_ADM_ROOM_DATE
        ;
    END IF;
    ...
    EXCEPTION
        WHEN NO_ADM_ID_EXCEPTION THEN
            O_ERRCODE := 'NO_ADM_ID_EXCEPTION';
            O_ERRMSG := '없는 ADM_ID입니다';
        WHEN OTHERS THEN
            O_ERRCODE := SQLCODE;
            O_ERRMSG := SQLERRM;
            
  END PROC_DEL_ADMISSION_ROOMS;
