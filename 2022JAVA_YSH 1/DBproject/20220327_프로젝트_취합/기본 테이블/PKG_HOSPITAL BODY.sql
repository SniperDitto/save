...
BEGIN
  ...
  OPEN O_CUR FOR
    ...
    WHERE HOS_ID LIKE '%'||IN_HOS_ID||'%'
        AND HOS_NAME LIKE '%'||IN_HOS_NAME||'%'
        AND HOS_ADDR_GRP LIKE '%'||IN_HOS_ADDR_GRP||'%'
        AND HOS_ADDR LIKE '%'||IN_HOS_ADDR||'%'
        AND HOS_ROOM_QTY LIKE '%'||IN_HOS_ROOM_QTY||'%'
        AND HOS_OPEN_DATE LIKE '%'||IN_HOS_OPEN_DATE||'%'
    ;
